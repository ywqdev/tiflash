...
DB::ColumnsWithTypeAndName ExecutorTest::executeMPPTasks(QueryTasks & tasks, DAGProperties &properties, std::unordered_map<size_t, MockServerConfig> & server_config_map)
{
